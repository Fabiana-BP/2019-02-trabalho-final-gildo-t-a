...
if (isset($_GET['bus_id'])) {
	$edit_bus_id = addslashes($_GET['bus_id']);
}
...
<form action="" method="post" enctype="multipart/form-data">
	...
	<div class="form-group">
		<label for="via-time">Tempo de viagem</label>
		<input value="<?php echo $time; ?>" type="text" class="form-control" name="via-time" placeholder="Horários separados por espaço">
	</div>
